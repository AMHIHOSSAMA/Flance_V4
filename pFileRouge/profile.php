    ...
    <div class="container " id="prfCont1">
        <div  class="row d-flex justify-content-center">
            ...
            <?php  if ($idFreelancer = $_SESSION["id_free"]){
                   echo "<div id='addProRow' class='row d-flex justify-content-end classPre'>
                            <div class='col-8'>
            ...
            } elseif ($idClient = $_SESSION["id_cli"]) {
                echo "<div id='offers_Divs2' class='row d-flex justify-content-end classPre'>
                <div class='col-9'>
        ...
        <div class='col'>
        <button id='addProRow10'  type='button' class='btn btn-primary d-flex justify-content-center addProRow10'><a href='offers.php'>Ajouter un offre</a> </button>
        </div>
        </div>";
